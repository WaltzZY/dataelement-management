...
public class FlowDefinition implements Serializable {
    ...
    @Size(max = 30, message = "流程编号最大长度要小于 30")
    ...
    private List<FlowTransferDefinition> flowTransferDefinitions;

    /**
     * 节点配置表关联数据
     */
    @TableField(exist = false)
    private List<FlowActivityDefinition> flowActivityDefinitions;
}